...
def get_user_list(config, key):
    with open('{}/MikuXProBot/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    API_ID = "8781248" 
    API_HASH = '329a9246cc001b67895fd68a85d0f86'
    TOKEN = "5393736227:AAGFFb0xChvQyZHrDKqk3e2ESBwQmras2ng"  #This var used to be API_KEY but it is now TOKEN, adjust accordingly.
    ...
    SUPPORT_CHAT = 'animefans_kerala'  #Your own group for support, do not add the @
